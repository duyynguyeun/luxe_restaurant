...
__export(index_exports, {
  default: () => useTreeChanges,
  treeChanges: () => import_tree_changes.default
});
...
function useTreeChanges(value) {
  ...
  const isEqual = (0, import_deep_equal.default)(previousValue.current, value);
  const previousIsEqual = (0, import_react.useRef)(isEqual);
  const instance = (0, import_react.useRef)(
    (0, import_tree_changes.default)(previousValue.current, value)
  );
  ...
  if (previousIsEqual.current !== isEqual || !isEqual) {
    ...
    instance.current = (0, import_tree_changes.default)(previousValue.current, value);
  }

...
function JoyrideOverlay(props) {
  ...
  const resizeTimeoutRef = (0, import_react3.useRef)();
  const scrollTimeoutRef = (0, import_react3.useRef)();
  const scrollParentRef = (0, import_react3.useRef)(null);
  ...
  const updateState = (0, import_react3.useCallback)(
    (state) => {
      if (!isMounted) {
        return;
      }
  ...
  const overlayStyles = (0, import_react3.useMemo)(() => {
  ...
  const spotlightStyles = (0, import_react3.useMemo)(() => {
    var _a, _b, _c;
  ...
  let spotlight2 = placement !== "center" && showSpotlight && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(JoyrideSpotlight, { styles: spotlightStyles });
...
function JoyrideBeacon(props) {
  ...
  if (beaconComponent) {
    ...
    component = /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
      BeaconComponent,
      {
        continuous,
        index,
    ...
    component = /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(
      "button",
      {
...
function JoyrideTooltipContainer(props) {
  ...
  output.close = !hideCloseButton && /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(JoyrideTooltipCloseButton, { "data-test-id": "button-close", styles: styles.buttonClose, ...closeProps });
...
function Tooltip(props) {
  ...
  if (tooltipComponent) {
    ...
    component = /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(TooltipComponent, { ...renderProps });
  } else {
...
function Joyride(props) {
  ...
  const content = {};
  const step = (0, import_react6.useMemo)(() => getMergedStep(props, steps[index]), [index, props, steps]);
  ...
  if (isRunning) {
    ...
    content.overlay = /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(JoyridePortal, { element, children: /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(
      JoyrideOverlay,
      {
        ...step,
        continuous,
...
function ReactJoyride(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(Joyride, { ...props });
}

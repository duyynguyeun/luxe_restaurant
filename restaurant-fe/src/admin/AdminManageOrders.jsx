                  ...
                  {order.status === 'PENDING' && (
                    <>
                      <button
                        ...
                        className="bg-blue-600 text-white px-4 py-2 rounded-lg text-sm font-semibold hover:bg-blue-700 shadow-md transition-transform active:scale-95"
                      >
                        💵 Xác nhận thanh toán
                      </button>
                      ...
                      <button
                        ...
                        className="bg-red-600 text-white px-4 py-2 rounded-lg text-sm font-semibold hover:bg-red-700 shadow-md transition-transform active:scale-95"
                      >
                        ❌ Hủy đơn
                      </button>
                    </>
                  ...
                  {order.status === 'PAID' && (
                    <>
                      <button
                        ...
                        className="bg-yellow-600 text-white px-4 py-2 rounded-lg text-sm font-semibold hover:bg-yellow-700 shadow-md transition-transform active:scale-95"
                      >
                        👨‍🍳 Đang chế biến
                      </button>

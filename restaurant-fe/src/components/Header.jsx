        ...
        <nav>
          <ul className="flex space-x-8 font-medium items-center text-white text-base">
            <li>
              ...
              <Link to="/" className="tour-home hover:text-yellow-400 transition-colors duration-300">Trang chủ</Link>
            </li>
            <li>
              {/* Thêm class 'tour-menu' */}
              <Link to="/menu" className="tour-menu hover:text-yellow-400 transition-colors duration-300">Thực đơn</Link>
            </li>
            <li>
            ...
            <li>
              ...
              <Link to="/cart" className="tour-cart hover:text-yellow-400 transition-colors duration-300">🛒 Giỏ hàng</Link>
            </li>
            <li>
              {/* Thêm class 'tour-orders' */}
              <Link to="/my-orders" className="tour-orders hover:text-yellow-400 transition-colors duration-300">Đơn hàng</Link>
            </li>
            ...
            <div className="tour-auth">
              {currentUser ? (
                  ...
                  <div className="absolute right-0 top-full pt-3 w-64 opacity-0 invisible group-hover:opacity-100 group-hover:visible transform group-hover:translate-y-0 translate-y-2 transition-all duration-300 ease-out">
                    <div className="bg-white rounded-xl shadow-2xl border border-gray-100 overflow-hidden relative">
                      ...
                      <div className="relative z-10 bg-white">
                        ...
                        <div className="p-2">
                          <Link to="/profile" className="flex items-center gap-3 px-4 py-3 text-sm text-gray-700 rounded-lg hover:bg-green-50 hover:text-[#174C34] transition-colors">
                ...
                <div className="flex items-center gap-4 ml-4">
                  <Link to="/login" className="text-white hover:text-yellow-300 font-medium transition-colors">Đăng nhập</Link>
                  <Link to="/signup" className="bg-yellow-500 text-[#174C34] px-5 py-2 rounded-full font-bold hover:bg-yellow-400 shadow-lg transform hover:-translate-y-0.5 transition-all">Đăng ký</Link>
                </div>
              )}
            </div>
          </ul>
